...
<div id="page">
    <form id="new_form" action="<?php self::php_url('member/new'); ?>" method="POST" enctype="application/x-www-form-urlencoded">
    ...
    <ul>
        <?php foreach ($members as $member): ?>
            <li><?php echo $member->name; ?> | <a href="<?php self::php_url('member/edit?id=' . $member->id); ?>">修改</a> | <a href="<?php self::csrf_url('member', 'member/delete?id=' . $member->id); ?>" onclick="return delete_member(this);">删除</a></li>
        <?php endforeach; ?>
    </ul>
</div>
