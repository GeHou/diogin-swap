...
INSERT INTO `setting` (`id`, `value`) VALUES (8, 'Copyright (c) 2009-2012 Jingcheng Zhang. All rights reserved.');
...
INSERT INTO `link` (`id`, `name`, `url`) VALUES (NULL, 'diogin的博客', 'http://www.diogin.net/');
INSERT INTO `link` (`id`, `name`, `url`) VALUES (NULL, 'swap框架官方网站', 'http://www.swapframework.org/');
