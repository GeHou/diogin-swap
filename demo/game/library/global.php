...
function g_arr($key, $default = array()) {
...
function p_arr($key, $default = array()) {
...
function c_arr($key, $default = array()) {
...
function url($target, $for_html = false) {
    return url_manager::build_url($target, false, $for_html);
}
function uri($target, $for_html = false) {
    return url_manager::build_url($target, false, $for_html, false);
}
function csrf_url($csrf_role, $target, $for_html = false) {
    return url_manager::build_csrf_url($csrf_role, $target, false, $for_html);
}
function csrf_uri($csrf_role, $target, $for_html = false) {
    return url_manager::build_csrf_url($csrf_role, $target, false, $for_html, false);
}
function h($value) {
