                ...
                <tr>
                    ...
                    <td>
                        <?php if ($board->last_post_user === ''): ?>
                            -
                        <?php else: ?>
                            <?php echo date('Y-m-d H:i:s', $board->last_post_time); ?><br /><a href="<?php self::php_url(array('user/show', array('name' => $board->last_post_user))); ?>"><?php echo $board->last_post_user; ?></a>
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php foreach ($board->manager as $manager): ?>
                            <a href="<?php self::php_url('user/show?id=' . $manager->id); ?>"><?php echo $manager->name; ?></a>
                        <?php endforeach; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
