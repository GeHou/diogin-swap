...
class session {
    ...
    public /* @core */ function __construct($role_name, session_store $session_store, $sid, $expire_time, $last_active, $role_id, $role_secret, array $role_vars) {
    ...
    public /* @core */ function needs_update($true_or_false = null) {
...
class session_manager {
    ...
    public static /* @core */ function create_session($role_name, $role_id, $sid, $login_seconds, array $role_vars) {
        $current_time = clock::get_stamp();
    ...
    public static /* @core */ function fetch_session($role_name, $sid) {
        $session_store = self::get_session_store($role_name);
    ...
    public static /* @core */ function remove_session($role_name, $sid) {
        self::get_session_store($role_name)->remove($sid);
    }
    public static /* @core */ function __init__() {
        self::$role_configs = config::get('technique.visitor.roles', array());
    }
    
    protected static function new_role_secret() {
        return sha1(config::get('technique.secret_key') . random_sha1());
    }
    ...
    protected static $role_configs = array();
